...
export default function VendorDashboard() {
  ...
  const [activeFilter, setActiveFilter] = useState<
    "all" | "featured" | "low-stock" | "high-value"
  >("all");
  ...
  const updateContactMutation = useMutation({
    mutationFn: (data: typeof contactData) =>
      apiRequest("PUT", "/api/vendor/contact", data),
    onSuccess: () => {
  ...
  const handleFilterChange = (
    filter: "all" | "featured" | "low-stock" | "high-value"
  ) => {
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3">
              <Button
                variant="outline"
                size="sm"
                className="border-slate-600 text-slate-200 hover:bg-slate-700 px-4 py-2"
                asChild
              >
                <Link href="/">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Track your performance and manage your products
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-purple-900">
                    {formatKESPrice(totalValue.toString())}
                  </p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-2 mb-8">
          <Tabs defaultValue="products" className="space-y-8">
            <TabsList className="grid grid-cols-4 w-full bg-slate-50 rounded-lg p-1 h-14">
              <TabsTrigger
                value="products"
                className="flex items-center gap-2 py-3 px-4 text-sm font-medium transition-all data-[state=active]:bg-white data-[state=active]:shadow-sm"
              >
                    ...
                    {productsLoading ? (
                      ...
                      <div className="space-y-3">
                        {filteredProducts().map((product) => (
                          <div
                            key={product.id}
                            className="group border border-slate-200 rounded-xl p-5 bg-gradient-to-r from-white to-slate-50 hover:shadow-lg hover:border-slate-300 transition-all duration-200"
                          >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-16 text-slate-500">
                    ...
                    <p>
                      Detailed sales reports and analytics will be available
                      here
                    </p>
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-16 text-slate-500">
                    ...
                    <p>
                      Customer orders will appear here when you start making
                      sales
                    </p>
                  </div>
                </CardContent>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Set up how customers can pay you
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        For Kenyan customers using M-Pesa
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-slate-500 mt-1">
                        Only share what's necessary for payments
                      </p>
                    </div>
                      ...
                      <div className="space-y-2 mt-2">
                        {[
                          ...
                          >
                            <Checkbox
                              id={method}
                              checked={contactData.acceptedPaymentMethods.includes(
                                method
                              )}
                              onCheckedChange={(checked) => {
                                if (checked) {
                                  setContactData({
                                    ...
                                    acceptedPaymentMethods: [
                                      ...contactData.acceptedPaymentMethods,
                                      method,
                                    ],
                                  });
                                } else {
                                  setContactData({
                                    ...contactData,
                                    acceptedPaymentMethods:
                                      contactData.acceptedPaymentMethods.filter(
                                        (m) => m !== method
                                      ),
                                  });
                                }
